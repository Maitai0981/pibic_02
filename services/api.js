...
function resolveBaseUrl() {
  ...
  const protocol = (extra.apiProtocol || process.env.EXPO_PUBLIC_API_PROTOCOL || 'http');
...
const API_PREFIX = extraOuter.apiPrefix || process.env.EXPO_PUBLIC_API_PREFIX || '/api';
